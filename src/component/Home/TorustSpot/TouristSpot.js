...
const TouristSpot = () => {
    ...
    if (spiner) {
        return <Spinner className="text-center" animation="border" variant="primary"></Spinner>
    }


    return (
        <div>
            <h1 className="text-center">Our Tourist Spot</h1>
            <Container>
                <Row className="g-1">
                    {
                        touristSpots.map(touristSpot => <Col md={4} sm={12} key={touristSpot._id}>
                            <div className="tour-card">
                                ...
                                <div className="tour-card-info">
                                    ...
                                    <div className="tour-card-btn mt-2" onClick={()=>handleBookNow(touristSpot._id)}>Book Now</div>
                                </div>
                            </div>
                        </Col>)
                    }
